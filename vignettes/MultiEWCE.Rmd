...
```{r get_HPO_data, message = FALSE, warning = FALSE, eval = FALSE}
...
```{r run, warning = FALSE, message = FALSE, eval = FALSE} 
...
```{r display, fig.width = 7, fig.height = 6, eval = FALSE}
print(plot1)
```
